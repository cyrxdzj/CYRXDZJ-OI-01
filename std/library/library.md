...
| 4~5   | $\le5\times10^4$ | $\le3\times10^4$ | $\le6\times10^4$ | $\le10$             | 书本不会更新，你只会收到消息 1；$c_i\le2$   |
| 6~7   | $\le5\times10^4$ | $\le3\times10^4$ | $\le6\times10^4$ | $\le1\times10^5$    | 书本不会更新，你只会收到消息 1；$c_i\le2$   |
| 8~9   | $\le5\times10^4$ | $\le3\times10^4$ | $\le6\times10^4$ | $\le1\times10^9$    | 书本不会更新，你只会收到消息 1；$c_i\le2$   |
...
| 样例3   | $\le5\times10^4$ | $\le3\times10^4$ | $\le6\times10^4$ | $\le1\times10^9$    | 符合测试点 6~7 的要求与特殊性质           |
